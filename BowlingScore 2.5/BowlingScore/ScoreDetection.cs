...
namespace BowlingScore
{
    public class ScoreDetection
    {
        ...
        public List<frame> playsPlayer1 = new List<frame>();
        public List<frame> playsPlayer2 = new List<frame>();
        ...
        {
            playsPlayer1[0] = assignStrikeorSpare(playsPlayer1[0]);
            playsPlayer1[1] = assignStrikeorSpare(playsPlayer1[1]);
            playsPlayer1[2] = assignStrikeorSpare(playsPlayer1[2]);
            playsPlayer1[3] = assignStrikeorSpare(playsPlayer1[3]);
            playsPlayer1[4] = assignStrikeorSpare(playsPlayer1[4]);
            playsPlayer1[5] = assignStrikeorSpare(playsPlayer1[5]);
            playsPlayer1[6] = assignStrikeorSpare(playsPlayer1[6]);
            playsPlayer1[7] = assignStrikeorSpare(playsPlayer1[7]);
            playsPlayer1[8] = assignStrikeorSpare(playsPlayer1[8]);
            playsPlayer1[9] = assignStrikeorSpare(playsPlayer1[9]);
            ...
            playsPlayer2[0] = assignStrikeorSpare(playsPlayer2[0]);
            playsPlayer2[1] = assignStrikeorSpare(playsPlayer2[1]);
            playsPlayer2[2] = assignStrikeorSpare(playsPlayer2[2]);
            playsPlayer2[3] = assignStrikeorSpare(playsPlayer2[3]);
            playsPlayer2[4] = assignStrikeorSpare(playsPlayer2[4]);
            playsPlayer2[5] = assignStrikeorSpare(playsPlayer2[5]);
            playsPlayer2[6] = assignStrikeorSpare(playsPlayer2[6]);
            playsPlayer2[7] = assignStrikeorSpare(playsPlayer2[7]);
            playsPlayer2[8] = assignStrikeorSpare(playsPlayer2[8]);
            playsPlayer2[9] = assignStrikeorSpare(playsPlayer2[9]);
